      ...
      for (var i = 0; i < features.length; i++) {
        ...
        if (currentMarkerPosition.y < 0 ||
          ...
          newOptions = L.extend({}, newOptions, ref);
           ...
           marker1 = L.rotatedMarker(this._map.containerPointToLatLng([x, y]), newOptions)
              .addTo(this._borderMarkerLayer);

          //marker1.on('click', this.onClick, marker1);
...
//
	var popup = L.popup({
        ...
        marker1.bindPopup(popup, {offset: new L.Point(24, 24)});
